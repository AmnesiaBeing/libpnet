...
fn one_someip_packet_detect() {
    ...
    let someippkt = SomeipPacket::check_and_new(&packet[..]).unwrap();
...
fn test_check_if_valid_someip() {
    ...
    println!("pkt1 is_someip?:{:?}", SomeipPacket::check_and_new(&pkt1));
    println!("pkt2 is_someip?:{:?}", SomeipPacket::check_and_new(&pkt2));
    println!("pkt3 is_someip?:{:?}", SomeipPacket::check_and_new(&pkt3));
    println!("pkt4 is_someip?:{:?}", SomeipPacket::check_and_new(&pkt4));
    println!("pkt5 is_someip?:{:?}", SomeipPacket::check_and_new(&pkt5));
}
